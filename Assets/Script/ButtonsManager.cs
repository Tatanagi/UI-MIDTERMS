...
public class ButtonsManager : MonoBehaviour
{
    ...
    {
        // Reset the image's properties to their original values
        imageToScale.transform.localScale = Vector3.one; // Reset scale
        imageToScale.transform.localPosition = originalPosition; // Reset position
        imageToScale.transform.rotation = Quaternion.identity; // Reset rotation
        imageToScale.color = originalColor; // Reset color
    }
